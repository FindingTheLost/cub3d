...
/*                                                                            */
/*                                                        :::      ::::::::   */
/*   t_game_draw_minimap_map_h.c                        :+:      :+:    :+:   */
/*                                                    +:+ +:+         +:+     */
/*   By: pde-alme <pde-alme@student.42lisboa.com>   +#+  +:+       +#+        */
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2026/05/17 19:43:26 by pde-alme          #+#    #+#             */
/*   Updated: 2026/05/28 18:55:59 by pde-alme         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
 ...
 * 		"t"  = "tile"; 
 */
static void	draw_tile_outline_h(t_game *g, int x, int y, int c)
{
	size_t	t;
	size_t	bx;
	size_t	by;
	...
	while (game->map->map[y])
	{
		...
		while (game->map->map[y][x])
		{
			if (game->map->map[y][x] == '0')
				draw_tile_outline_h(game, x, y, LIME);
			else if (game->map->map[y][x] == '1')
				draw_tile_outline_h(game, x, y, SWAMP);
			else if (game->map->map[y][x] == ' ')
				draw_tile_outline_h(game, x, y, BLACK);
			else if (game->map->map[y][x] == 'D')
				draw_tile_outline_h(game, x, y, RED6);
			else if (game->map->map[y][x] == 'O')
				draw_tile_outline_h(game, x, y, BLUE0);
			x++;
		}
		y++;
	}
