...
/*   Updated: 2026/05/01 03:22:14 by pde-alme         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void	show_help_map(void)
{
	...
	ft_printf(" - A " RED_BOLD "1" DEF " represents a wall;\n");
	ft_printf(" - A " RED_BOLD "0" DEF " represents a traversable floor");
	ft_printf(" surface;\n");
	ft_printf(" - The characters " RED_BOLD "N" DEF "," RED_BOLD " S" DEF);
	ft_printf(", " RED_BOLD "E" DEF ", " RED_BOLD "W" DEF " represent ");
	...
	ft_printf(" - A map cannot possess an empty line, however, ");
...
static void	show_help_usage(void)
{
	...
	ft_printf("A " RED_BOLD ".cub" DEF " file can be composed by the ");
